  ...
  return (
    <div className={styles.footerParent}>
      <div className={styles.createBy}>
        ...
        <span className={[styles.myName, "unselectable"].join(" ")}>
          Kalpesh
        </span>
      </div>
      ...
      <div className={styles.socialParent}>
        ...
        <div className={styles.socialSites}>
          <a
            href="mailto:kalpesh22nimje@gmail.com"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/kalpesh-nimje-305862234"
            target="_blank"
            className={styles.siteIcons}
          >
          ...
          <a
            href="https://instagram.com/kalpeshn003?igshid=OGQ5ZDc2ODk2ZA=="
            target="_blank"
            className={styles.siteIcons}
          >
